...
import { Box, IconButton, Table, TableBody, TableCell, TableRow, Collapse } from '@mui/material';
import { KeyboardArrowDown as KeyboardArrowDownIcon, KeyboardArrowUp as KeyboardArrowUpIcon } from '@mui/icons-material';
import Checkbox from '@mui/material/Checkbox';

const RowTableCurrentPrices = ({ item, handleItemSelected }: any) => {
            ...
            <TableRow sx={{ boxShadow: 2 }} className="table__mainRow">
                <TableCell className="table__cellAux">
                    <Table>
                        <TableBody>
                            <TableRow
                                className="table__row table__courseProgramBodyArticles"
                                hover={true}
...
export default RowTableCurrentPrices;
